 ...
 */
import { ALL_RUNTIME_IDS } from "./runtime-registry.js";
...
export const COMMAND_SIGNATURES: Readonly<Record<string, CommandSchema>> = {
  ...
  init: {
    ...
    signature: {
      ...
      positionals: [],
      flags: [
        { name: "runtime", type: "string", values: ALL_RUNTIME_IDS, summary: "Target runtime" },
        { name: "all", type: "boolean", summary: "Write all native runtimes: claude, antigravity, codex (mutually exclusive with --runtime; excludes the agents-md fallback)" },
